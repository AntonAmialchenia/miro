...
export function useViewState() {
  ...
  const goToIdle = () => setViewState({ type: "idle", selectedIds: new Set() });
  ...
  const goToAddSticker = () => setViewState({ type: "add-sticker" });
...
export type ViewStateResult = ReturnType<typeof useViewState>;
